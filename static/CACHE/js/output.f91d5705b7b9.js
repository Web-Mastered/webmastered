...
function sidenav_control_toggle(){alert("You button was pressed");sidenav_control_counter++;if(isEven(sidenav_control_counter)){}else{$("label").addClass("form-label")
$("input").addClass("form-control")
$("textarea").addClass("form-control")
$("input").addClass("form-control")}};;$(document).ready(function(){$('.toast-notifications').toast('show');});AOS.init({disable:false,startEvent:'DOMContentLoaded',initClassName:'aos-init',animatedClassName:'aos-animate',useClassNames:false,disableMutationObserver:false,debounceDelay:50,throttleDelay:99,offset:0,delay:0,duration:400,easing:'ease',once:false,mirror:false,anchorPlacement:'center-bottom',});function isOnScreen(elem){if(elem.length==0){return;}
