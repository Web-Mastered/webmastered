...
$("textarea").addClass("form-control");Sentry.init({dsn:"",integrations:[new Sentry.Integrations.BrowserTracing()],tracesSampleRate:1.0,release:"1.0.0",environment:"development",});$(document).ready(function(){$('.toast-notifications').toast('show');});;