...
toast_status=toast_status+1;}});});;Sentry.init({dsn:"",integrations:[new Sentry.Integrations.BrowserTracing()],tracesSampleRate:1.0,release:"1.0.0",environment:"development",});$(document).ready(function(){setTimeout(function(){document.dispatchEvent(new Event('startAOS'));},2000);});AOS.init({disable:false,startEvent:'startAOS',initClassName:'aos-init',animatedClassName:'aos-animate',useClassNames:false,disableMutationObserver:false,debounceDelay:50,throttleDelay:99,offset:0,delay:0,duration:400,easing:'ease',once:false,mirror:false,anchorPlacement:'center-bottom',});;