...
function sidenav_control_toggle(){sidenav_control_counter++;console.log(sidenav_control_counter)
if(isEven(sidenav_control_counter)){$(".sidenav").removeClass("d-flex")
$(".sidenav").removeClass("w-100")
$(".sidenav").removeClass("high-z-index")
$(".sidenav").addClass("d-none")}else{$(".sidenav").removeClass("d-none")
