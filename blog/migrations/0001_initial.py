    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name your category.', max_length=255, unique=True)),
                ('slug', models.SlugField(allow_unicode=True, help_text='A slug to identify posts by this category.', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', modelcluster.fields.ParentalManyToManyField(blank=True, to='blog.BlogPostCategory')),
            ],
            options={
