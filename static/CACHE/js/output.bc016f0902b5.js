...
toast_status=toast_status+1;}});});$("label").addClass("form-label");Sentry.init({dsn:"",integrations:[new Sentry.Integrations.BrowserTracing()],tracesSampleRate:1.0,release:"1.0.0",environment:"development",});;